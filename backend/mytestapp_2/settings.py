"""
Django settings for mytestapp_2 project.
...
WSGI_APPLICATION = 'mytestapp_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mytestapp_2 API",
    "DESCRIPTION": "API documentation for mytestapp_2 App",
    "VERSION": "v1",
}
